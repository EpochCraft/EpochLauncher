...
async function showMainUI(data){
    ...
    setTimeout(() => {
        ...
        document.body.style.backgroundImage = `url('https://raw.githubusercontent.com/EpochCraft/EpochLauncher/refs/heads/master/app/assets/images/backgrounds/${document.body.getAttribute('bkid')}.jpg')`
        $('#main').show()
